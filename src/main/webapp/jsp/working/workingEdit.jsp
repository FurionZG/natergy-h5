...
<div class="mui-content">
    ...
    <div style="padding-top: 30px">
        ...
        <div class="mui-content-padded" style="margin-top: 20px;">
            <button id='id_btnSave' type="button" class="mui-btn mui-btn-success" style="width: 100%;">修改工作进程
            </button>
        </div>
...
<script>
    $(document).ready(function loading() {
        ...
        var json = eval("(" + localStorage.getItem("working") + ")");
        console.log(json);
        $("#date").text(json.date);
        $("#todayWorking").text(json.todayWorking);
        $("#tomorrowWorking").text(json.tomorrowWorking);
        $("#marks").val(json.marks);
        $("#id").val(json.id);
        var imgStr ="";
        for(var i=0;i<json.images.length;i++){
            imgStr+='<img style="width: 150px;height: 150px; margin-left: 15px;margin-top: 15px;" src="http://219.146.150.102:20005/' + json.images[i] + '"/>'
        }
        $("#dd").html(imgStr);
