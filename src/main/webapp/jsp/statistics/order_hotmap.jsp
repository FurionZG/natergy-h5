...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-1.7.1.js"></script>
      	...
      	<script type="text/javascript" src="<%=request.getContextPath()%>/js/nty_salehotmap_show.js"></script>
        							...
        							<div class="mui-input-group">
        								...
        								<div class="mui-input-row">
        									...
        									<div>
        										...
        										<button id='starttime'  data-options='{}'  style="margin:3px;width:110px;height:33px;float:left" class="btn mui-btn mui-btn-block">开始时间</button>
        							 			...
        							 			<div id="start" class="mui-input-clear"  style="height:40px;float:left;margin-top: 10px;"></div>
        								...
        								<div class="mui-input-row">
        									...
        									<div>
        							    		...
        							    		<div style="height:40px;width:80px;float:left"></div>
        							    		<div id="end" class="mui-input-clear"  style="height:40px;float:left;margin-top: 10px;"></div>
        							 	   </div>
        								</div>
