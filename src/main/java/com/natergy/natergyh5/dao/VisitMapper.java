...
public interface VisitMapper {
    ...
    @Select("select 客户编码 from 销售客户资料 where 客户名称=#{customerName} and 业务经理 like CONCAT('%',#{user},'%') and 状态!='删除'")
    String selectCustomerNo(String customerName,String user);

    @Select("select Id from 销售客户资料 where 客户名称=#{customerName} and 业务经理 like CONCAT('%',#{user},'%') and 状态!='删除'")
    String selectCustomerId(String customerName,String user);

    @Select("select * ,销售客户资料.`联系人手机`  tel1,`销售客户资料`.`联系人姓名`  contacts1 from 销售拜访 LEFT  join  销售客户资料 on 销售拜访.客户资料Id=销售客户资料.Id where (`销售拜访`.`客户经理`=#{uname}  or `销售拜访`.可阅人 like CONCAT('%',#{uname},'%')) and 销售拜访.状态!='删除' order by `销售拜访`.Id desc limit 30")
    @Results({
            @Result(property = "customerName", column = "客户名称"),
            @Result(property = "user", column = "客户经理"),
            ...
            @Result(property = "businessNo",column = "出差编号")

    })
    List<Visit> getVisitsByUser(String uname);

    @Update("update 销售拜访 set 供应商或干燥剂类型=#{productBrand},现用单价=#{price},拜访记录=#{record},省份=#{province},城市=#{city},地址=#{address} where id=#{id}")
    ...
    @Select("select *,销售客户资料.`联系人手机`  tel1,`销售客户资料`.`联系人姓名`  contacts1 from 销售拜访 LEFT  join  销售客户资料 on 销售拜访.客户资料Id=销售客户资料.Id where (`销售拜访`.`客户经理`=#{uname} or `销售拜访`.可阅人 like CONCAT('%',#{uname},'%'))and 销售拜访.状态!='删除' order by `销售拜访`.Id desc limit #{limit},5")
    @Results({
            @Result(property = "customerName", column = "客户名称"),
            @Result(property = "date", column = "时间"),
            @Result(property = "user", column = "客户经理"),
    ...
    @Select("select *,销售客户资料.`联系人手机`  tel1,`销售客户资料`.`联系人姓名`  contacts1 from 销售拜访 LEFT  join  销售客户资料 on 销售拜访.客户资料Id=销售客户资料.Id where `销售拜访`.`出差编号`=#{businessNo} and 销售拜访.状态!='删除' order by `销售拜访`.Id desc")
    @Results({
            @Result(property = "customerName", column = "客户名称"),
            @Result(property = "date", column = "时间"),
            @Result(property = "user", column = "客户经理"),
    ...
    @Select("select *,销售客户资料.`联系人手机`  tel1,`销售客户资料`.`联系人姓名`  contacts1 from 销售拜访 LEFT  join  销售客户资料 on 销售拜访.客户资料Id=销售客户资料.Id where `销售拜访`.`出差编号`=#{businessNo} and 销售拜访.客户名称=#{customerName} and  销售拜访.状态!='删除' order by `销售拜访`.Id desc")
    @Results({
            @Result(property = "customerName", column = "客户名称"),
            @Result(property = "date", column = "时间"),
            @Result(property = "user", column = "客户经理"),
    ...
    @Select("select *,销售客户资料.`联系人手机`  tel1,`销售客户资料`.`联系人姓名`  contacts1 from 销售拜访 LEFT  join  销售客户资料 on 销售拜访.客户资料Id=销售客户资料.Id where  销售拜访.客户名称=#{customerName} and 销售拜访.客户经理=#{uname} and 销售拜访.状态!='删除' order by `销售拜访`.Id desc")
    @Results({
            @Result(property = "customerName", column = "客户名称"),
            @Result(property = "date", column = "时间"),
            @Result(property = "user", column = "客户经理"),
